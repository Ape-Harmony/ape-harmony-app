...
export class VaultReceiptNft extends ethereum.SmartContract {
  static bind(address: Address): VaultReceiptNft {
    return new VaultReceiptNft("VaultReceiptNft", address);
  }
